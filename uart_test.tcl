#*****************************************************************************************
# Vivado (TM) v2020.2_AR76668 (64-bit)
#
...
set file "[file normalize "$origin_dir/src/uart_pins.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/uart_pins.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.771429",
...
preplace port uart -pg 1 -lvl 4 -x 1010 -y 130 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 310 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 3 -x 880 -y 140 -defaultsOSRD
...
preplace netloc axi_uartlite_0_UART 1 3 1 NJ 130
levelinfo -pg 1 0 230 610 880 1010
pagesize -pg 1 -db -bbox -sgen 0 0 1130 420
"
}
